...
public class FileClientTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// /Users/yoonchairyeon/doc/test.txt
			// /Users/yoonchairyeon/Documents/itwill/java/aa.txt
			path = scn.next();
			...
			while((byteData = fis.read(buffer, 0, 1024))!=-1) {
				...
				System.out.println(byteData + "bytes 전송 중!!!");
